::: center
[Gopal sharma]{.smallcaps}\
[  [+91-9069367364]{.underline}  ](tel:+919069367364) [ [connect2gopu@gmail.com]{.underline}](mailto:connect2gopu@gmail.com)   [ [linkedin/whogopu]{.underline}](https://linkedin.com/in/whogopu)   [ [github/whogopu]{.underline}](https://github.com/whogopu)   [ [leetcode/whogopu]{.underline}](https://leetcode.com/u/whogopu/)  
:::

# TECHNICAL SKILLS

::: itemize
**Languages:** Javascript, Typescript, C/C++, Java, Python, SQL, NoSQL.\
**Frontend:** React.js, Next.js, Redux, React Native, React Query, TailwindCSS, Figma, HTML, CSS.\
**Backend:** Node.js, Express.js, AWS, Firebase, RESTful APIs, GraphQL.\
**Build, Tooling & DevOps:** Git, Postman, Jira, Jest, Webpack, Babel, Vite, Docker, Nginx.\
...
- --------------------------------------------------- -------------------------
    ...
    *[Team Lead (Software Engineering)]{.underline}*       *Noida, Uttar Pradesh*
    --------------------------------------------------- -------------------------
...
- ----------------------------------- -------------------------
    ...
    *[Software Engineer]{.underline}*                     *Delhi*
    ----------------------------------- -------------------------
...
- ------------------------------------------------ --------------------------
    ...
    *Bachelor of Technology - **Grade** - **71%***               *Delhi, India*
    ------------------------------------------------ --------------------------
